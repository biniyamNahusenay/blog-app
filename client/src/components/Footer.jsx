    ...
    <Footer container className='border border-t-8 border-teal-500'>
       <div className='w-full max-w-7xl mx-auto'>
            ...
            <div className='grid grid-cols-2 gap-8 mt-4 sm:grid-cols-3 sm:gap-6'>
               <div>
                 ...
                 <Footer.LinkGroup col>
                    <Footer.Link href='#'>100js projects</Footer.Link>
                    <Footer.Link href='#'>Bini's Blog</Footer.Link>
                 </Footer.LinkGroup>
               </div>
               <div>
         ...
         <div className='w-full sm:flex sm:items-center sm:justify-between'>
           <Footer.Copyright href='#' by="Bini's Blog" year={new Date().getFullYear()}/>
            <div className='flex gap-3 sm:mt-0 mt-4 sm:justify-center'>
               <Footer.Icon href="#" icon = {BsFacebook}/>
               <Footer.Icon href="#" icon = {BsTwitter}/>
               <Footer.Icon href="#" icon = {BsInstagram}/>
               <Footer.Icon href="https://github.com/biniyamNahusenay" icon = {BsGithub}/>
